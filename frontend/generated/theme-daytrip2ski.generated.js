...
import stylesCss from 'themes/daytrip2ski/styles.css?inline';
...
import vaadinButtonCss from 'themes/daytrip2ski/components/vaadin-button.css?inline';
import vaadinPasswordFieldCss from 'themes/daytrip2ski/components/vaadin-password-field.css?inline';
import vaadinTextAreaCss from 'themes/daytrip2ski/components/vaadin-text-area.css?inline';
import vaadinTextFieldCss from 'themes/daytrip2ski/components/vaadin-text-field.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_daytrip2ski_componentCss']) {
    registerStyles(
      'vaadin-button',
    ...
    document['_vaadintheme_daytrip2ski_componentCss'] = true;
  }
